"""
Django settings for turtle_orm project.
...
SECRET_KEY = "acp1i_sn$y2wfhpk(w5ce%qk177*rjy2c71bcziio-9ez_qm*%"
...
LOGGING = {
    ...
    "handlers": {
        ...
        "file": {
            ...
            "filename": "/home/scratch/monctrl/sparrow_logs/turtle_orm/{}.log".format(
                getuser()
            ),
            "formatter": "verbose",
        },
